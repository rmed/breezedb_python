...
class TestElement(unittest.TestCase):
    ...
    def test_element_exists_true(self):
        ...
        result = breeze.element.element_exists(2, field, table, database)
        self.assertEqual(True, result)

    def test_element_exists_false(self):
        # Check for an element that does not exist
        result = breeze.element.element_exists(10, field, table, database)
        self.assertEqual(False, result)
        
    def test_get_element(self):
        # Get the data of element located in position 1
        expected = 'Paris'
        result = breeze.element.get_element(1, field, table, database)
    ...
    def test_get_element_inexistent(self):
        ...
        with self.assertRaises(breeze.element.ElementException):
            breeze.element.get_element(10, field, table, database)

    def test_find_element(self):
        # Find the index for 'Madrid'
        expected = 3
        result = breeze.element.find_element('Madrid', field, table, database)
    ...
    def test_find_element_inexistent(self):
        ...
        expected = []
        result = breeze.element.find_element('Tokyo', field, table, database)
        # Must return an empty array
        self.assertEqual(expected, result)

    def test_modify_element(self):
        # Modify the last element
        breeze.element.modify_element(4, 'Nowhere', field, table, database)

    def test_modify_element_inexistent(self):
        # Modify the last element
        with self.assertRaises(breeze.element.ElementException):
            breeze.element.modify_element(35, 'Test Name', field, table, database)

    def test_empty_element(self):
        # Empty the content of element 0
        breeze.element.empty_element(0, field, table, database)

    def test_empty_element_inexistent(self):
        # Attempt to empty the content of an inexistent element
        with self.assertRaises(breeze.element.ElementException):
            breeze.element.empty_element(10, field, table, database)
